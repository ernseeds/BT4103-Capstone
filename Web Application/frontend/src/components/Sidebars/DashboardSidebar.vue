<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<div class="brand"><img src="images/racing.png" alt=""> <span>Landscanner</span></div>
			<hr>
			...
			<a-menu theme="light" mode="inline">
				...
				<a-menu-item>
					<router-link to="/CarFeaturesAnalytics">
						<span class="icon">
						...
						<span class="label">Car Features Analytics</span>
					</router-link>
				</a-menu-item>
				<a-menu-item>
					<router-link to="/DemandInsights">
						<span class="icon">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<span class="label">Demand Insights</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/Landscanner">
						...
						<span class="label">Landscanner</span>
					</router-link>
				</a-menu-item>
				<a-menu-item>
					<router-link to="/PricePrediction">
						<span class="icon">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<span class="label">Price Prediction</span>
					</router-link>
				</a-menu-item>
			</a-menu>
			<!-- / Sidebar Navigation Menu -->
